    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ssn', models.CharField(max_length=14, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_ssn', message='SSN must be 14 numeric digits', regex='^[0-9]{14}$')])),
